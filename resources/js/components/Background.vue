<template>
    <div class="svg-container">
        <svg version="1.1" id="background" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            width="100%" height="100%" viewBox="0 0 255 255" enable-background="new 0 0 255 255" xml:space="preserve">
            <g stroke="#FFF" stroke-width="2" fill="none">
                <path d="M158,196.1c-8.3,0-14.1-2.9-17.2-8.5l-28-51v48.7c0,2.5-0.9,5.9-5.3,8.3c-3,1.6-6.6,2.5-10.7,2.5
                ...
                <path d="M117.3,213.3V213c0-1.5-1.2-2.6-2.6-2.6h-4.5v-4.5c0-1.5-1.2-2.6-2.6-2.6h-0.2c-1.5,0-2.6,1.2-2.6,2.6v4.5
                ...
                <path d="M53.5,157.8c-4.5,0-8.2,3.7-8.2,8.2s3.7,8.2,8.2,8.2c4.5,0,8.2-3.7,8.2-8.2S58.1,157.8,53.5,157.8z
                    M53.5,168.8c-1.5,0-2.7-1.2-2.7-2.7s1.2-2.7,2.7-2.7c1.5,0,2.7,1.2,2.7,2.7S55,168.8,53.5,168.8z"/>
                <path d="M73.5,111v-0.2c0-1.5-1.2-2.6-2.6-2.6H23.3c-1.5,0-2.6,1.2-2.6,2.6v0.2c0,1.5,1.2,2.6,2.6,2.6h47.5
                    C72.3,113.6,73.5,112.4,73.5,111z"/>
                <path d="M56.9,98.5h6.4c1.5,0,2.6-1.2,2.6-2.6v-0.2c0-1.5-1.2-2.6-2.6-2.6h-6.4c-1.5,0-2.6,1.2-2.6,2.6v0.2
                    C54.3,97.3,55.4,98.5,56.9,98.5z"/>
                <path d="M42.5,122.5c-1.5,0-2.6,1.2-2.6,2.6v0.2c0,1.5,1.2,2.6,2.6,2.6h9.1c1.5,0,2.6-1.2,2.6-2.6v-0.2
                    c0-1.5-1.2-2.6-2.6-2.6H42.5z"/>
                <path d="M112.6,139.5L112.6,139.5c0-1.3-0.9-2.4-2.2-2.6v5.2C111.6,141.9,112.6,140.8,112.6,139.5z"/>
            </g>
        </svg>
    </div>
</template>
